...
public class AccountAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.beizhuTv.setText(bean.getRecord());
    ...
    class ViewHolder{
        ...
        public ViewHolder(View view){
            typeIv = view.findViewById(R.id.item_main_src);
            typeTv = view.findViewById(R.id.item_main_tv1);
            timeTv = view.findViewById(R.id.item_main_tv_time);
            beizhuTv = view.findViewById(R.id.item_main_tv2);
            moneyTv = view.findViewById(R.id.item_main_tv_money);
