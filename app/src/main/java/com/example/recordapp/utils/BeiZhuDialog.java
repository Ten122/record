...
public class BeiZhuDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_record);//设置对话框显示布局
        et = findViewById(R.id.dialog_record_ed);
        cancelBtn = findViewById(R.id.dialog_record_cancel);
        ensureBtn = findViewById(R.id.dialog_record_ensure);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.dialog_record_cancel:
                cancel();
                break;
            case R.id.dialog_record_ensure:
